...
<body class="bg-gray-100 h-screen">
    ...
    <main class="mx-auto max-h-[92.9%] flex pt-44">
        <section class="w-[15%] p-2 border-r flex flex-col gap-3 border-gray-300 bg-gray-100" id="sidebar">
            ...
            <!-- Services -->
            <a class="flex items-center gap-2 bg-gray-800 py-2 px-4 rounded text-white hover:bg-gray-900 transition-colors" href="#services">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 3v3.75H6a2.25 2.25 0 000 4.5h3.75V15H6a2.25 2.25 0 000 4.5h3.75V21M12.75 3v3.75H18a2.25 2.25 0 010 4.5h-5.25V15H18a2.25 2.25 0 010 4.5h-5.25V21" />
                </svg>
                Services
            </a>
            <!-- À propos -->
            <a class="flex items-center gap-2 bg-gray-800 py-2 px-4 rounded text-white hover:bg-gray-900 transition-colors" href="#about">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Contact -->
            <a class="flex items-center gap-2 bg-gray-800 py-2 px-4 rounded text-white hover:bg-gray-900 transition-colors" href="#contact">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a3 3 0 003.22 0L21 8m-9 5.75V19m0-11v2.75M2 12.5V19a2 2 0 002 2h16a2 2 0 002-2v-6.5" />
                </svg>
                Contact
            </a>
            <!-- Blog -->
            <a class="flex items-center gap-2 bg-gray-800 py-2 px-4 rounded text-white hover:bg-gray-900 transition-colors" href="#blog">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7c0 1.19-.51 2.27-1.33 3.02M3 7a6.002 6.002 0 0011.33 3.02M5.67 5A2.5 2.5 0 007 5h2a2.5 2.5 0 012.5 2.5m-.5 4.5V21m-3 0H9m6 0h-3" />
                </svg>
                Blog
            ...
            <!-- FAQ -->
            <a class="flex items-center gap-2 bg-gray-800 py-2 px-4 rounded text-white hover:bg-gray-900 transition-colors" href="#faq">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.5 12.5a2.5 2.5 0 005 0c0-1.5-2.5-2-2.5-2m0-3h.01m-6.01 13h16a2 2 0 002-2V7a2 2 0 00-2-2h-4.586a2 2 0 01-1.414-.586l-2.414-2.414A2 2 0 009.586 2H5a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
                FAQ
            </a>
        </section>
        ...
        <section class="w-[85%] p-4 overflow-y-auto" id="main-content">
            ...
            echo "<h2 class='text-xl mb-4'>Données des Pays et Villes</h2>";
        ...
        "; 
            ...
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
                echo "<h2 class='text-xl m-4'>Données des Pays</h2>";
                echo "<table class='min-w-full bg-white border border-gray-300 rounded-lg shadow'><thead><tr class='bg-blue-200'><th class='border px-4 py-2'>ID Pays</th><th class='border px-4 py-2'>Nom Pays</th><th class='border px-4 py-2'>Population</th><th class='border px-4 py-2'>Langues Officielles</th><th class='border px-4 py-2'>Continent</th></thead><tbody>";
                while ($row = $result->fetch_assoc()) {
                    echo "<tr class='hover:bg-blue-100 transition-colors duration-200'>
                        <td class='border px-4 py-2'>" . $row["id_pays"] . "</td>
            ...
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
                echo "<h2 class='text-xl m-4'>Données des Villes</h2>";
                echo "<div class='w-full h-[50vh] overflow-auto'>";
